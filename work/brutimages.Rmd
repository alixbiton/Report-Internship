...
Pour traiter les nuages par le package OpenEO, il existe l'option `cloud_cover` qui trie les images ayant moins d'un certain pourcentage de couverture nuageuse (ici 30%). Il existe aussi la bande SCL (<https://brazil-data-cube.github.io/specifications/bands/SCL.html>) qui classe tous les pixels en plusieurs catégories :
...
```{r function,warning = FALSE, results = FALSE, message=FALSE, eval = false}
bbox = list(west=44.98, south=-13.01, east=45.30, north=-12.61)
dossier_out = "../filepath" 
