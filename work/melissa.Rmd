...
This image show the result of the integrated product **Integrated** of the `computeExposure` function I've been developing for my internship. This function compute, for each point of the MNT, the topographic exposure to wind when there was the maximum speed wind.
